...
public class FraudDetector extends KeyedProcessFunction<Long, Transaction, Alert> {
	...
	public void open(Configuration parameters) throws Exception {
		...
		timerState = getRuntimeContext().getState(longValueStateDescriptor);
	}
	...
	public void processElement(
		...
		Boolean lastTransactionFlag = flagState.value();
		double amount = transaction.getAmount();
		//上一次状态是否被更新
		if (lastTransactionFlag != null){
	 ...
	 * @throws Exception
	 */
	private void clearUp(Context ctx) throws Exception {
